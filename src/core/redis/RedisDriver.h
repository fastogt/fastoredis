...
namespace fastoredis
{
    ...
    protected:
        ...
        virtual void serverPropertyEvent(Events::ServerPropertyRequestEvent *ev);
        virtual void serverPropertyChangeEvent(Events::ServerPropertyChangeRequestEvent *ev);
