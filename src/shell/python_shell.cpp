...
namespace
{
    ...
    {
        "lrem", "pipeline", "setex",
        "zadd", "append", "bgrewriteaof",
        "bgsave", "blpop", "brpop",
        "brpoplpush", "config_get", "config_set",
        "dbsize", "debug_object", "decr",
        "delete", "echo", "execute_command",
        "exists", "expire", "expireat",
        "flushall", "flushdb", "get",
        "getbit", "getset", "hdel",
        ...
        "lset", "ltrim", "mget",
        "move", "mset", "msetnx",
        "object", "parse_response", "persist",
        "ping", "pipeline", "publish",
        "pubsub", "randomkey", "rename",
        "renamenx", "rpop", "rpoplpush",
        "rpush", "rpushx", "sadd",
        "save", "scard", "sdiff",
        "sdiffstore", "set", "set_response_callback",
        "setbit", "setex", "setnx",
        "setrange", "shutdown", "sinter",
        "sinterstore", "sismember", "slaveof",
        "slowlog_get", "slowlog_len", "slowlog_reset",
        "smembers", "smove", "sort",
        "spop", "srandmember", "srem",
        "strlen", "substr", "sunion",
        "sunionstore", "transaction", "ttl",
        "type", "unwatch", "watch",
        "zadd", "zcard", "zincrby",
        ...
        "disconnect", "get_connection", "make_connection",
        "release", "connect", "disconnect", "encode",
        "on_connect", "pack_command", "read_response",
        "send_command", "send_packed_command"
    };
}
