IF(${CMAKE_SYSTEM_NAME} MATCHES "Linux")
    ADD_DEFINITIONS(-DOS_LINUX -DOS_POSIX -DWCHAR_T_IS_UTF16)
ELSEIF(${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
    ADD_DEFINITIONS(-DOS_MACOSX -DOS_POSIX -DWCHAR_T_IS_UTF32)
ELSEIF(${CMAKE_SYSTEM_NAME} MATCHES "Windows")
    ADD_DEFINITIONS(-D_WIN32 -DOS_WIN -DWCHAR_T_IS_UTF16)
ELSE()
