...
ELSEIF(${CMAKE_SYSTEM_NAME} MATCHES "Android")
    SET(OS_ANDROID ON)
    ADD_DEFINITIONS(-DOS_ANDROID -DANDROID -DJabber)
    SET(TARGET_INSTALL_DESTINATION ${ANDROID_NDK_ABI_NAME})
    MESSAGE(STATUS "ANDROID_NDK_ABI_NAME: ${ANDROID_NDK_ABI_NAME} ANDROID_STL: ${ANDROID_STL} BUILD_WITH_ANDROID_NDK: ${BUILD_WITH_ANDROID_NDK} ANDROID_EXPLICIT_CRT_LINK: ${ANDROID_EXPLICIT_CRT_LINK}")
ELSEIF(${CMAKE_SYSTEM_NAME} MATCHES "BlackBerry")
    SET(OS_BLACKBERRY ON)
    ADD_DEFINITIONS(-DOS_BLACKBERRY -DOS_POSIX -DUNIX -DQ_OS_BLACKBERRY)
ELSEIF(${CMAKE_SYSTEM_NAME} MATCHES "iOS")
    SET(OS_IOS ON)
    ADD_DEFINITIONS(-DOS_IOS -DOS_IPHONE -DOS_POSIX -DUNIX)
ELSEIF(${CMAKE_SYSTEM_NAME} MATCHES "WindowsPhone")
    SET(OS_WINPHONE ON)
    SET(USE_UDT OFF)
    SET(USE_CXX_STANDART ON)
