...
MACRO(DEFINE_DEFAULT_DEFINITIONS)
    ...
    STRING(REGEX REPLACE "([a-zA-Z])" "'\\1'" PROJECT_NAME_ESCAPED_SYMBOLS "${PROJECT_NAME}")
    STRING(REGEX REPLACE "''" "','" PROJECT_NAME_DELEMITED "${PROJECT_NAME_ESCAPED_SYMBOLS}")
    ADD_DEFINITIONS(
        ...
        -DPROJECT_NAME_DELEMITED=${PROJECT_NAME_DELEMITED}
...
FUNCTION(FIND_RUNTIME_LIBRARY OUT_VAR DLIB_NAMES)
    IF(MINGW)
        GET_FILENAME_COMPONENT(Mingw_Path ${CMAKE_CXX_COMPILER} PATH)
        FIND_LIBRARY(OUT_VAR_FIND_${OUT_VAR} NAMES ${${DLIB_NAMES}} HINTS ${Mingw_Path})
        IF(NOT OUT_VAR_FIND_${OUT_VAR})
            MESSAGE(SEND_ERROR "FIND_RUNTIME_LIBRARY not found ${OUT_VAR}")
        ELSE()
